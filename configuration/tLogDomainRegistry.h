...
#ifndef __rrlib__logging__configuration__tLogDomainRegistry_h__
#define __rrlib__logging__configuration__tLogDomainRegistry_h__
...
/*! In RRLib logging messages can be send via several logging domains.
 *  These have to be created and maintained using a single instance of
 *  this class. Thus, this class registers a list of active logging domains
 *  and configurations that either were created along with active domains
 *  or were configured by the user from a file or calling the appropriate
 *  methods.
 *  It must be used via the singleton holder typedef below.
 */
class tLogDomainRegistryImplementation
{
...
public:
  ...
  /*! Ctor of tLogDomainRegistryImplementation
   *
   */
  tLogDomainRegistryImplementation();

  /*! Dtor of tLogDomainRegistryImplementation
   *
   */
  ~tLogDomainRegistryImplementation();
...
//  std::vector<tConfigurationSharedPointer> domain_configurations;
...
//   */
//  tConfigurationSharedPointer GetConfigurationByName(const std::string &name);
//
...
typedef util::tSingletonHolder<tLogDomainRegistryImplementation, util::singleton::CreateUsingNew, util::singleton::NoDestruction> tLogDomainRegistry;
